function [  new_feature  ] = block16(X,Y,train_label,alpha,u,block_num,w,h,index )
...
train_mat16=normc(train_mat16); test_mat16=normc(test_mat16);
  ...
  new_feature5 = get_feature( train_mat5,test_mat5,train_label,alpha,u ,index);
  new_feature6 = get_feature( train_mat6,test_mat6,train_label,alpha,u ,index);
  new_feature7 = get_feature( train_mat7,test_mat7,train_label,alpha,u ,index);
  new_feature8 = get_feature( train_mat8,test_mat8,train_label,alpha,u ,index);
  new_feature9 = get_feature( train_mat9,test_mat9,train_label,alpha,u ,index);
  new_feature10 = get_feature( train_mat10,test_mat10,train_label,alpha,u ,index);
  new_feature11 = get_feature( train_mat11,test_mat11,train_label,alpha,u,index );
  new_feature12 = get_feature( train_mat12,test_mat12,train_label,alpha,u ,index);
  new_feature13 = get_feature( train_mat13,test_mat13,train_label,alpha,u,index );
  new_feature14 = get_feature( train_mat14,test_mat14,train_label,alpha,u ,index);
  new_feature15 = get_feature( train_mat15,test_mat15,train_label,alpha,u ,index);
  new_feature16 = get_feature( train_mat16,test_mat16,train_label,alpha,u,index );
